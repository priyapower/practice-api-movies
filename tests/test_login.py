...
class TestUserLogin(BaseCase):
    ...
    def test_login_with_invalid_email(self):
        ...
        response = self.app.post('/api/v1/auth/signup', headers={"Content-Type": "application/json"}, data=json.dumps(payload))

        # When
        payload['email'] = "paurakh012@gmail.com"
        response = self.app.post('/api/v1/auth/login', headers={"Content-Type": "application/json"}, data=json.dumps(payload))
